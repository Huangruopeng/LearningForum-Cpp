...
public:
    ...
    void setupUi(QMainWindow *BoardWin)
    {
        ...
        BoardWin->resize(1200, 1000);
        BoardWin->setMinimumSize(QSize(1200, 1000));
        ...
        actionlogout = new QAction(BoardWin);
        ...
        sizePolicy.setHeightForWidth(Profile_btn->sizePolicy().hasHeightForWidth());
        Profile_btn->setSizePolicy(sizePolicy);
        Profile_btn->setStyleSheet(QStringLiteral("border-image: url(:/png/ProfilePic.png);"));

        horizontalLayout_6->addWidget(Profile_btn);
        ...
        sizePolicy2.setHeightForWidth(Board_1->sizePolicy().hasHeightForWidth());
        Board_1->setSizePolicy(sizePolicy2);
        ...
        horizontalLayout_4->addWidget(search_LE);
        ...
        sizePolicy4.setHeightForWidth(search_btn->sizePolicy().hasHeightForWidth());
        search_btn->setSizePolicy(sizePolicy4);

        horizontalLayout_5->addWidget(search_btn);
    ...
    void retranslateUi(QMainWindow *BoardWin)
    {
        ...
        actionlogout->setText(QApplication::translate("BoardWin", "logout", nullptr));
        ...
        search_btn->setText(QApplication::translate("BoardWin", "\346\220\234\347\264\242", nullptr));
        ...
        menu->setTitle(QApplication::translate("BoardWin", "\346\263\250\351\224\200", nullptr));
    } // retranslateUi
