...
istream & operator >> (istream & in,Comment *c)
{
    ...
    if(s=="#"){
        ...
        throw MyException("Board信息中Comment格式错误！");
...
istream & operator >> (istream & in,Post *p)
{
    ...
    if(s=="##"){
        ...
        throw MyException("Board中Post信息格式错误！");
...
ifstream & operator >> (ifstream & in,GeneralUser *g)
{
   ...
   // int ismoderator;
    ...
    if(s=="###"){
        ...
        throw MyException("普通用户信息文件格式错误！");
    }
...
ifstream & operator >> (ifstream & in, ModeratorUser *m)
{
    ...
    if(s=="###"){
        ...
        throw MyException("版主用户信息文件格式错误！");
...
void Forum::logout() //now i don't know how to construct
{
     ofstream out1;
     try{
         out1.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/fileboard.txt");
         if(!out1)
             throw invalid_argument("board信息无法保存！");
     }
     catch(exception & e){
     ...
     ofstream out2;
     try{
         out2.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/fileadmin.txt");
     }
     catch(exception &e){
     ...
     ofstream out3;
     try{
         out3.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/filegeneral.txt");
     }
     catch(exception &e){
     ...
     ofstream out4;
     try{
         out4.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/filemoderator.txt");
     }
     catch(exception &e){
...
void Forum::Init()
{
   /* GeneralUser *g1,*g2,*g3;
    ...
    ifstream in1;
    try{
        in1.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/fileadmin.txt");//暂时先用绝对路径
        if(!in1)
          throw invalid_argument("admin文件打开错误");
      }
    catch(exception &e){
       QMessageBox::warning( NULL,("Warning"), (QString::fromStdString(e.what())));
      }
    ...
    try{
       ...
       for(int j=0;j<num;j++){
        ...
        QMessageBox::warning( NULL,("Error"), ("Caught a exception:"+e.getMessage()+"\n这里程序不关闭"));
         //abort();
    }
    ...
    ifstream in2;
    try{
        in2.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/filegeneral.txt");
        if(!in2)
            throw invalid_argument("general打开错误！");
    }
    catch (exception &e){
        QMessageBox::warning( NULL,("Warning"), (QString::fromStdString(e.what())));
    }
   ...
   try{
    ...
    ifstream in3;
       try{
            in3.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/filemoderator.txt");
            if(!in3)
                throw invalid_argument("mederator打开错误！");
           }
       catch (exception &e){
              QMessageBox::warning( NULL,("Warning"), (QString::fromStdString(e.what())));
           }
    ...
    f.board.clear();
     ifstream in4;
     try{
          in4.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/fileboard.txt");
          if(!in4)
              throw invalid_argument("board打开错误！");
         }
     catch (exception &e){
           QMessageBox::warning( NULL,("Warning"), (QString::fromStdString(e.what())));
         }
...
void Forum::Saveforum() //now i don't know how to construct
{
     ofstream out1;
     try{
         out1.open("C:/Users/Rocair/Desktop/CppWork/LearningForumV2/LearningForumV2/fileboard.txt");
